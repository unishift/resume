...
{\usekomafont{part} Eugene Lyapustin} \hfill \faPhone~+7 925 538 39 58 \\%\faMapMarker~Yerevan, Armenia \\
...
\faAngleDoubleRight~ \textsc{English}\quad{Full working proficiency}\qquad
\faAngleDoubleRight~ \textsc{Russian}\quad{Native speaker}
